...
module.exports = {
    ...
    execute(message, client) {
        ...
        const specificUsers = ['562741216840515594', '528410587093401603', '544341005420199937']; // list of ids to detect
        ...
        if (message.channel.id === channelId && specificUsers.includes(message.author.id)) {
